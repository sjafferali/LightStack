  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="m-0 text-[13px] text-[#8e8e93]">Complete log of all alert triggers and clears</p>
      </div>
      ...
      <div className="mb-4 flex gap-4">
        <input
          ...
          className="rounded-lg border border-[#3a3a3c] bg-[#2c2c2e] px-4 py-2 text-sm text-white font-mono focus:border-[#0a84ff] focus:outline-none"
        />
        <select
          value={filterAction}
          onChange={(e) => {
          ...
          <tbody>
            {isLoading ? (
              ...
              history.map((entry, idx) => (
                ...
                >
                  <td className="px-5 py-4 text-[13px] text-[#8e8e93] font-mono">
                    {formatDate(entry.created_at)}
                  </td>
                  <td className="px-5 py-4 font-medium font-mono">{entry.alert_key}</td>
                  <td className="px-5 py-4">
                    <span
                      className={`rounded px-2.5 py-1 text-[11px] font-semibold uppercase font-mono ${
      ...
      {totalPages > 1 && (
        <div className="mt-4 flex items-center justify-center gap-2">
          ...
          <span className="px-4 text-sm text-[#8e8e93] font-mono">
