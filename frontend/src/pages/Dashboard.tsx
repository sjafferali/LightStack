      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          <h2 className="m-0 flex items-center text-lg font-bold">
            Active Alerts
            <span
              className={`ml-3 rounded-xl px-2.5 py-1 font-mono text-xs font-bold ${
        ...
        {activeAlerts.length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {activeAlerts.map((alert, idx) => (
              <Card
                key={alert.alert_key}
                className="animate-slide-up grid grid-cols-[1fr_auto_auto] items-center gap-5"
                style={{
              ...
              >
                ...
                <div className="text-right">
                  <p className="m-0 font-mono text-xs text-[#8e8e93]">Triggered</p>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <Card key={stat.label} className="text-center">
            ...
            <p className="m-0 font-mono text-[32px] font-bold" style={{ color: stat.color }}>
              {stat.value}
            </p>
          </Card>
        ))}
        ...
        {selectedAlert && (
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-3">
              ...
              <span className="rounded bg-[rgba(52,199,89,0.2)] px-2.5 py-1 font-mono text-[11px] font-semibold uppercase text-[#34c759]">
                ACTIVE
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="rounded-lg bg-[#2c2c2e] p-4">
                ...
                <p className="m-0 font-mono text-sm">{selectedAlert.config?.trigger_count ?? 0}</p>
              </div>
            </div>
